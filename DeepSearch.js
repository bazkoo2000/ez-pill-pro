javascript:(function(){
  'use strict';
  // ═══════════════════════════════════════════════════════════════════
  // EZ-PILL PRO v4.6 - (المحرك المتوازي المطور)
  ...
  async function scanPage() {
    ...
    elMsg.innerHTML = '<div style="width:16px;height:16px;border:2px solid #bfdbfe;border-top-color:#3b82f6;border-radius:50%;animation:aliSpin 0.8s linear infinite"></div><span>جاري سحب البيانات متوازياً...</span>';
