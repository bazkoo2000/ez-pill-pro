...
document.getElementById('ez-t-1772758542123').onclick=function(){javascript:(function(){    var id = 'print-spacer-element';    var spacer = document.getElementById(id);    if (spacer) {        spacer.remove();    } else {        var div = document.createElement('div');        div.id = id;        div.style.display = 'block';        div.style.height = '0';        div.style.pageBreakAfter = 'always';        div.style.breakAfter = 'page';        document.body.prepend(div);    }})();};
