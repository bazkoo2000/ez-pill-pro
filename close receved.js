javascript:(function(){
  ...
  function getPageSignature() {
    ...
    return rows.map(row => row.querySelector('td') ? row.querySelector('td').innerText.trim() : '').join('|||');
  }
