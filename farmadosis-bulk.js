(async function () {
  ...
  async function loadIntakes(){
    ...
    try{var resp=await apiFetch(API_ROOT+"/centers/"+ids.centerId+"/intakes-association",{headers:{Authorization:"Bearer "+token,Accept:"application/json, text/plain, */*"}});
      if(resp.ok){var data=await resp.json();INTAKES=(Array.isArray(data)?data:data.items||data.data||[]).filter(function(i){return i.is_active;}).sort(function(a,b){var aSahor=a.name.indexOf("\u0627\u0644\u0633\u062d\u0648\u0631")>-1?1:0;var bSahor=b.name.indexOf("\u0627\u0644\u0633\u062d\u0648\u0631")>-1?1:0;if(aSahor!==bSahor)return aSahor-bSahor;return(a.hour*60+a.minute)-(b.hour*60+b.minute);});addLog("Loaded "+INTAKES.length+" dose times","ok");}}
